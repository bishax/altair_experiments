...
PROFILE = default
PROJECT_NAME = altair_experiments
...
fetch:
	$(PYTHON_INTERPRETER) altair_experiments/fetch_data.py
	make sync_data_to_s3

## Sync raw from s3 and make Dataset
data:
	sync_data_from_s3
	$(PYTHON_INTERPRETER) altair_experiments/make_dataset.py
...
lint:
	black altair_experiments; flake8 altair_experiments
